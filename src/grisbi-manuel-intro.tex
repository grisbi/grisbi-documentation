...
Si vous avez envie de compiler régulièrement les dernières évolutions du code de Grisbi à partir du \gls{Git}, vous trouverez avantage à vous abonner à la \lang{liste
d'informations du Git}\footnote{\urlListCVSEmail{}} afin d'être averti des
\cmd{commit}.
...
Pour l'instant, seule la \lang{liste de traduction anglaise}\footnote{\urlListAnglaiseEmail{}} est créée.
